...
function updateMaxScale(original, updated){
	 $.post('../scripts/queries/updateMaxScale',{maxscale1_:original, maxscale2_: updated},function(data){
      		return true;
    });
}

function updateMinScale(original, updated){
	 $.post('../scripts/queries/updateMinScale',{minscale1_:original, minscale2_: updated},function(data){
      		return true;
    });
}
